...
mod tests {
    ...
    fn it_works() {
        ...
        assert_eq!(tazo.row_index(), 0);
        assert_eq!(tazo.col_index(), 0);
        ...
        assert_eq!(shenen.row_index(), 3);
        assert_eq!(shenen.col_index(), 0);
        ...
        assert_eq!(wulev.row_index(), 1);
        assert_eq!(wulev.col_index(), 1);
